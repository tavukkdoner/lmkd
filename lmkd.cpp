...
static void mp_event_psi(int data, uint32_t events, struct polling_params *poll_params) {
    ...
    if (memevent_listener) {
        ...
        is_kswapd_awake = kswapd_start_tm.tv_sec != 0 || kswapd_start_tm.tv_nsec != 0;
    } else {
        in_direct_reclaim = vs.field.pgscan_direct != init_pgscan_direct;
        is_kswapd_awake = (vs.field.pgscan_kswapd != init_pgscan_kswapd) ||
