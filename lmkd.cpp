...
static void mp_event_psi(int data, uint32_t events, struct polling_params *poll_params) {
    ...
    static int64_t filecache_wmark_kb = 0;
    ...
    if (cycle_after_kill && wmark < WMARK_LOW) {
        ...
        filecache_wmark_kb = filecache_min_kb;
        ...
        if (file_lru_kb < filecache_wmark_kb) {
            ...
            snprintf(kill_desc, sizeof(kill_desc),
                ...
                file_lru_kb, filecache_wmark_kb);
            min_score_adj = PERCEPTIBLE_APP_ADJ + 1;
        } else {
            /* File cache is big enough, stop killing */
            filecache_wmark_kb = 0;
        }
    }
