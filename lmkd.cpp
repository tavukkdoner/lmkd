...
static bool is_memevents_direct_reclaim_monitor_enabled;
...
static void mp_event_psi(int data, uint32_t events, struct polling_params *poll_params) {
    ...
    in_direct_reclaim =
            is_memevents_direct_reclaim_monitor_enabled
...
static void destroy_direct_reclaim_monitoring() {
    if (memevent_listener_fd < 0) return;
...
static bool init_monitors() {
    ...
    is_memevents_direct_reclaim_monitor_enabled = init_direct_reclaim_monitoring();
    if (is_memevents_direct_reclaim_monitor_enabled) {
